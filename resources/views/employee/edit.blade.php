        ...
        <div class="tab-content border p-4 mt-2" id="empTabContent">
            ...
            <div class="tab-pane fade tab-step" id="contact" role="tabpanel">
                <div class="form-group">
                    ...
                    <input type="text" name="aadhaar_number" class="form-control" maxlength="12" value="{{ $employee->aadhaar_number }}">
                </div>
                <div class="form-group mt-2">
                    <label>Mobile</label>
                    <input type="text" name="mobile" class="form-control" maxlength="10" required value="{{ $employee->mobile }}">
                </div>
                <div class="form-group mt-2">
                    <label>Email</label>
            ...
            <div class="tab-pane fade tab-step" id="job" role="tabpanel">
                <div class="form-group">
                    ...
                    <input type="text" name="designation" class="form-control" required value="{{ $employee->designation }}">
                </div>
                <div class="form-group mt-2">
                    <label>Date of Joining</label>
                    <input type="date" name="date_of_joining" class="form-control" required value="{{ $employee->date_of_joining }}">
                </div>
                <div class="d-flex justify-content-between mt-3">
                    <button type="button" class="btn btn-secondary prev-tab">Previous</button>
                    <button type="button" class="btn btn-primary next-tab">Next</button>
            ...
            <div class="tab-pane fade tab-step" id="docs" role="tabpanel">
                <div class="form-group">
                    ...
                    <input type="file" name="profile_photo" class="form-control" value="{{ $employee->profile_photo }}">
                </div>
                <div class="form-group mt-2">
                    <label>ID Proof (Aadhaar / PAN)</label>
                    <input type="file" name="id_proof" class="form-control" value="{{ $employee->id_proof }}">
                </div>
                <div class="d-flex justify-content-between mt-3">
                    <button type="button" class="btn btn-secondary prev-tab">Previous</button>
